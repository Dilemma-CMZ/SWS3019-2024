...
average_by_communityAverage_category = df.groupby('communityAverage_category')['buildingType_bungalow'].mean().reset_index()

# 使用Seaborn绘制点状图
sns.scatterplot(data=average_by_communityAverage_category, x='communityAverage_category', y='buildingType_bungalow')
