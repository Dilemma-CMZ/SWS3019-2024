...
# 使用Seaborn绘制点状图
sns.scatterplot(data=average_by_communityAverage_category, x='percentage_range', y='buildingType_plate')
...
# 将点的坐标数据导出到CSV文件
average_by_communityAverage_category.to_csv('../../data/corelation/population_vs_plate.csv', index=False, columns=['percentage_range', 'buildingType_plate'])